...
ms.locfileid: "138051442"
---
# <a name="simple-concat-travistravis-imagetravis-url-npmnpm-imagenpm-url-downloadsdownloads-imagedownloads-url-javascript-style-guidestandard-imagestandard-url"></a>simple-concat [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![unduhan][downloads-image]][downloads-url] [![panduan gaya javascript][standard-image]][standard-url]
...
### <a name="super-minimalist-version-of-concat-stream-less-than-15-lines"></a>Versi super-minimalis dari [`concat-stream`](https://github.com/maxogden/concat-stream). Kurang dari 15 baris!
...
Contoh ini lebih panjang dari implementasinya.
