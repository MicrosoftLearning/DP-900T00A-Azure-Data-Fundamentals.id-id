...
ms.locfileid: "138051049"
---
# <a name="installation"></a>Penginstalan
> `npm install --save @types/stoppable`

# <a name="summary"></a>Ringkasan
Paket ini berisi definisi jenis untuk stoppable (https://github.com/hunterloftis/stoppable).

# <a name="details"></a>Detail
File diekspor dari https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/stoppable.
 ...
 * Terakhir diperbarui: Sen, 31 Mei 2021 17:01:23 GMT
 * Dependensi: [@types/node](https://npmjs.com/package/@types/node)
 * Nilai global: tidak ada

# <a name="credits"></a>Kredit
Definisi ini ditulis oleh [Eric Byers](https://github.com/EricByers), [John Plusjé](https://github.com/jplusje), dan [BendingBender](https://github.com/BendingBender).
